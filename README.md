...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/qtpy-uic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2315&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qtpy-uic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qtpy-uic` can be installed with:

```
conda install qtpy-uic
```

It is possible to list all of the versions of `qtpy-uic` available on your platform with:
